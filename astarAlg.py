...
# modified code from https://gist.github.com/ryancollingwood/32446307e976a11a1185a5394d6657bc
...
def astar(maze, start, end, allow_diagonal_movement = False):
    ...
    adjacent_squares = ((0, 1), (-1, 0), (1, 0), (-1, -1), (-1, 1), (1, -1), (1, 1),)
    ...
    while len(open_list) > 0:
        ...
        for child in children:
            ...
            new_score = current_node.g + 1
            if (maze[child.position[0]][child.position[1]] == 2) :
                new_score = current_node.g + 100000
